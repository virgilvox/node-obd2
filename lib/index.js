...
(function (OBD2) {
    var Main = (function (_super) {
        ...
        Main.prototype.listPID = function (callBack) {
            var _this = this;
            ...
            if (this.PID.getList().length > 0) {
                ...
                this._tickListPID(pidSupportList, function (a) {
                    callBack(_this.PID.getList());
                });
            }
        };
        Main.prototype.listDTC = function (callBack) {
         ...
         * @param callBack
         */
        Main.prototype.writePID = function (replies, loop, pidNumber, pidMode, callBack) {
            var _this = this;
            // Arguments
         ...
         * @param callBack
         */
        Main.prototype.sendPID = function (pidNumber, pidMode, callBack) {
         ...
         * @param callBack
         */
        Main.prototype.readPID = function (pidNumber, pidMode, callBack) {
        ...
        Main.prototype._tickListDTC = function (callBack) {
            /*if ( this.PID.getListECU().length > 0 && this.PID.getListECU().indexOf( cmdPid ) < 0 )
            {
                callBack();
            }*/
